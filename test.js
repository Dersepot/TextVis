...
//}
function addRoom(n,ct=1){
	let x=getTemplate("room-template"); x.querySelector(".residents>i").innerHTML=ct
	n.parentNode.insertBefore(x,n)
}
function delRoom(n){n.parentNode.parentNode.removeChild(n.parentNode);}
